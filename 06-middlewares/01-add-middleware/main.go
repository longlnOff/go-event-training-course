...
func main() {
	...
	router.AddHandler(
		...
		func(msg *message.Message) ([]*message.Message, error) {
			...
			newMessage.Metadata.Set("Correlation-ID", msg.Metadata.Get("Correlation-ID"))
	...
	router.AddConsumerHandler(
		...
		func(msg *message.Message) error {
			...
			// TODO
			correlationID := msg.Metadata.Get("Correlation-ID")
	...
	e.POST("/players", func(c echo.Context) error {
		...
		msg.Metadata.Set("Correlation-ID", correlationID)
